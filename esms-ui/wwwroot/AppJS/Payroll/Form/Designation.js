...
$($(document)).on('click', '#btn_idgenerate', function (e) {
    setid()
});

// ✅ FIXED setid() function to assign valid empty GUID
function setid() {
    $("#txt_id").val("00000000-0000-0000-0000-000000000000");
}
...
$('table').on('click', '.btn-edit', async function (e) {
    ...
    await GETBYID(end_point + "/GetDesignationById", _id, _name, function (response) {
        petchdata(response)
    });
});
