...
namespace API.Migrations
{
    ...
    [Migration("20230416180028_UpdateDepartment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.AssetType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Models.RequestAssign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Models.Asset", b =>
                {
                    ...
                    b.HasOne("API.Models.AssetType", "AssetTypes")
                        .WithMany()
                        .HasForeignKey("Type")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("API.Models.Request", b =>
                {
                    ...
                    b.HasOne("API.Models.RequestType", "RequestTypes")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Models.RequestAssign", b =>
                {
                    b.HasOne("API.Models.Request", "Requests")
                        .WithMany()
